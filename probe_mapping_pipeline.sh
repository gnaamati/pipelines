# http://www.ebi.ac.uk/seqdb/confluence/display/ensf/How+to+run

## Screen?

pipeline_name=probemapping_grape
...
core_server=mysql-ens-plants-prod-1-ensrw 
...
## Random config
tempdir=/hps/nobackup/flicek/ensembl/plants/${USER}/array_mapping/temp
...
probe_directory=/nfs/production/flicek/ensembl/plants/array_mapping
